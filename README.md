...
- **Key Discovery:** Validated that initial **Discount** and **Region** are the strongest systemic predictors of long-term churn.
...
## Key Conclusions
1. **Discipline Over Volume:** 9.2% of orders were "Loss Anomalies" driven by unsustainable discounts; eliminating these provides an immediate [Total Loss Amount] profit recovery.
...
3. **Resource Realignment:** Logistics must be used as a retention tool for "Champions" rather than a hidden subsidy for one-off buyers.
